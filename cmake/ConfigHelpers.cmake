...
function(cpk_setup_target CPK_SETUP_NAME)
  # Prepare the args
  cmake_parse_arguments(CPK_SETUP "MAIN" "TARGET_TYPE;TARGET_NAME;TARGET_LIBRARY_PREFIX" "TARGET_COMPILE_DEFINITIONS;TARGET_LINK_LIBRARIES" "${ARGN}")
  ...
  if (CPK_SETUP_TARGET_TYPE STREQUAL "shared")
    ...
    set(IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/lib/${CPK_SETUP_TARGET_LIBRARY_PREFIX}${CPK_SETUP_TARGET_NAME}${CMAKE_IMPORT_LIBRARY_SUFFIX}")
  elseif (CPK_SETUP_TARGET_TYPE STREQUAL "static")
    if ("${CPK_SETUP_TARGET_LIBRARY_PREFIX}" STREQUAL "")
      set(CPK_SETUP_TARGET_LIBRARY_PREFIX "${CMAKE_STATIC_LIBRARY_PREFIX}")
    endif()
    set(IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/lib/${CPK_SETUP_TARGET_LIBRARY_PREFIX}${CPK_SETUP_TARGET_NAME}${CMAKE_STATIC_LIBRARY_SUFFIX}")
  elseif (CPK_SETUP_TARGET_TYPESTREQUAL "executable")
    set(IMPORTED_LOCATION "${PACKAGE_PREFIX_DIR}/bin/${CPK_SETUP_TARGET_NAME}${CMAKE_EXECUTABLE_SUFFIX}")
